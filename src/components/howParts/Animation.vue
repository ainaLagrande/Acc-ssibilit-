        ...
        <div class="how-parts-box">
            <div class="how-parts-item">
                <Accordion :multiple="true">
                    <AccordionTab header="Assurez-vous que les animations sont subtiles et ne clignotent pas trop.">
                        <p>Certains types d'animations stroboscopiques ou clignotantes déclencheront des crises. D'autres peuvent être distrayants et perturbateurs, en particulier pour certains types de troubles cognitifs tels que le TDAH.
                        </p>
                    </AccordionTab>
                    ...
                    <AccordionTab header="Assurez-vous que toutes les animations respectent la prefers-reduced-motion requête média.">
                        ...
                        Supprimez les animations lorsque le paramètre "prefers-reduced-motion" est activé. Si une animation est nécessaire pour communiquer le sens d'un concept, ralentissez sa durée.</p>
                    </AccordionTab>
                </Accordion>
            </div>
        </div>
