        ...
        <div class="how-parts-box">
            <div class="how-parts-item">
                <Accordion :multiple="true">
                    <AccordionTab header="Bien masquer votre contenu">
                        ...
                        Dans l’exemple ci-dessous, ce texte va être affiché à l’écran, sera lisible mais n'apparaîtra pas côté HTML. Autrement dit, les technologies d'assistance n’ont aucun moyen de savoir que ce texte existe.
